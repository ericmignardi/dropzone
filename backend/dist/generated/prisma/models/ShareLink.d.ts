...
export type GetShareLinkAggregateType<T extends ShareLinkAggregateArgs> = {
    [P in keyof T & keyof AggregateShareLink]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateShareLink[P]> : Prisma.GetScalarType<T[P], AggregateShareLink[P]>;
};
...
type GetShareLinkGroupByPayload<T extends ShareLinkGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ShareLinkGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ShareLinkGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ShareLinkGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ShareLinkGroupByOutputType[P]>;
}>>;
export type ShareLinkWhereInput = {
    ...
    shortCode?: Prisma.StringFilter<"ShareLink"> | string;
    ...
    fileId?: Prisma.StringFilter<"ShareLink"> | string;
...
export type ShareLinkScalarWhereWithAggregatesInput = {
    ...
    shortCode?: Prisma.StringWithAggregatesFilter<"ShareLink"> | string;
    ...
    fileId?: Prisma.StringWithAggregatesFilter<"ShareLink"> | string;
...
export type ShareLinkOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "shortCode" | "password" | "expiresAt" | "fileId" | "createdAt", ExtArgs["result"]["shareLink"]>;
...
export type ShareLinkCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ShareLinkFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ShareLinkDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends ShareLinkCountArgs>(args?: Prisma.Subset<T, ShareLinkCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ShareLinkCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ShareLinkGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ShareLinkGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetShareLinkGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface ShareLinkFieldRefs {
    ...
    readonly shortCode: Prisma.FieldRef<"ShareLink", 'String'>;
